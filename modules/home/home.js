...
<body>
    ...
    <div id="app" class="max-w-6xl mx-auto min-h-screen flex flex-col pb-20">
        ...
        <!-- SLIDESHOW -->
        <div class="glass mx-4 mb-6 relative overflow-hidden" style="min-height:180px">
    ...
    <!-- BOTTOM NAV -->
    <nav class="bottom-nav">        <a href="#home" class="nav-item active"><i class="fas fa-house"></i><span>Home</span></a>
        <a href="#booking" class="nav-item"><i class="fas fa-calendar-check"></i><span>Booking</span></a>
    ...
    <script>
        ...
        // ===== MENU MAP (ICON FIXED - FA FREE 6.4.0) =====
        const menuMap={
            ...
            'booking-officer':{name:'Officer',sub:'Booking',icon:'fa-user-tie',color:'bg-gradient-to-br from-blue-600 to-blue-900'},
            'booking-approval':{name:'Approval',sub:'Booking',icon:'fa-circle-check',color:'bg-gradient-to-br from-green-500 to-green-700'},
            'k3':{name:'K3',sub:'Laporan',icon:'fa-triangle-exclamation',color:'bg-gradient-to-br from-orange-500 to-orange-700'},
            'k3-officer':{name:'K3',sub:'Officer',icon:'fa-shield-check',color:'bg-gradient-to-br from-orange-600 to-orange-900'},
            ...
            'janitor-outdoor':{name:'Janitor',sub:'Outdoor',icon:'fa-leaf',color:'bg-gradient-to-br from-cyan-500 to-cyan-700'},            'stok':{name:'Stok',sub:'Alat',icon:'fa-box-archive',color:'bg-gradient-to-br from-purple-600 to-purple-800'},
        ...
        async function router(){
            ...
            if(path){
                ...
                }catch(e){main.innerHTML='<p class="text-center text-red-400"><i class="fas fa-triangle-exclamation text-2xl mb-2"></i><br>Error: '+e.message+'</p>'}
            }
        }
